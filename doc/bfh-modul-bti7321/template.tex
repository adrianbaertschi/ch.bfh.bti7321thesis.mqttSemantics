...
\input{vorspann/titelseite_mit_bild}			% activate for Titelseite mit Bild
\input{vorspann/versionen}
\cleardoubleemptypage
\setcounter{page}{1}
\cleardoublepage
\phantomsection 
\addcontentsline{toc}{chapter}{Management Summary}
\input{vorspann/management_summary}
\cleardoubleemptypage
%---------------------------------------------------------------------------
...
\input{kapitel/projectmanagement}
\input{kapitel/technologie}
\input{kapitel/konzept}
\input{kapitel/requirements}
\input{kapitel/spez_schema}
\input{kapitel/umsetzung}
\input{kapitel/verifikation}
...
\input{vorspann/selbstaendigkeitserklaerung}
%---------------------------------------------------------------------------
...
\appendix
\settocdepth{section}
\input{anhang/arbeitsjournal} % TODO: remove?
%---------------------------------------------------------------------------
